...
class acint_purchase(models.Model):
    ...
    expenses_purchase = fields.One2many('acint.purchase.import.expenses', 'import_factor_id', string=u'Otros Gastos (DOP)', states=READONLY_STATES)
...
class ImportExpenses(models.Model):
    _name = 'acint.purchase.import.expenses'
